...
```json
{
  ...
  "logo": "https://alojamientostossademar.com/img/favicon.png",
...
```html
<link rel="canonical" href="https://alojamientostossademar.com/es/rooms/el-berganti/" />
...
Sitemap: https://alojamientostossademar.com/sitemap-index.xml
```
